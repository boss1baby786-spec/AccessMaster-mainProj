                        ...
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to AccessMaster.</p>
                              @if (session('success'))
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> App. Crafted with <i class="mdi mdi-heart text-danger"></i> by HT
                            </p>
                        </div>
                    </div>
                </div>
