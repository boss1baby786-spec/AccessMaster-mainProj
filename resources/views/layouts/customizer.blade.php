            ...
            <div data-simplebar class="h-100">
                <div class="p-4">
                    ...
                    <div class="form-check form-switch form-switch-md mb-3 mt-4">
                        <input type="checkbox" class="form-check-input" name="sidebarUserProfile"  id="sidebarUserProfile">
    ...
    <script>
        console.log('Theme customizer JS loaded');

document.querySelectorAll('#theme-settings-offcanvas input').forEach(element => {
element.addEventListener('change',()=>{
console.log('Preference changed');
    let preferences={
        layout:document.querySelector('input[name="data-layout"]:checked')?.value,
                theme :document.querySelector('input[name="data-theme"]:checked')?.value,
                color_scheme :document.querySelector('input[name="data-bs-theme"]:checked')?.value,
                sidebar_visibility :document.querySelector('input[name="data-sidebar-visibility"]:checked')?.value,
               sidebarUserProfile:document.querySelector('input[name="sidebarUserProfile"]').checked ? "show" : "hide",
                layout_width :document.querySelector('input[name="data-layout-width"]:checked')?.value,
                layout_position:document.querySelector('input[name="data-layout-position"]:checked')?.value,
                topbar_color :document.querySelector('input[name="data-topbar"]:checked')?.value,
                sidebar_size :document.querySelector('input[name="data-sidebar-size"]:checked')?.value,
                sidebar_view :document.querySelector('input[name="data-layout-style"]:checked')?.value,
                sidebar_color :document.querySelector('input[name="data-sidebar"]:checked')?.value,
                sidebar_image :document.querySelector('input[name="data-sidebar-image"]:checked')?.value,
                primary_color :document.querySelector('input[name="data-theme-colors"]:checked')?.value,
                preloader :document.querySelector('input[name="data-preloader"]:checked')?.value,
